...
import gipsl.all.build.implication.shortcut.connector.ImplicationShortcutConnector;

public class GipslAllBuildImplicationShortcutTest extends AGipslAllBuildTest {

	// Setup method

	public void callableSetUp() {
		gen.persistModel(MODEL_PATH);
		con = new ImplicationShortcutConnector(MODEL_PATH);
	}
	...
	public Class<?> getConnectorClass() {
		return ImplicationShortcutConnector.class;
	}
